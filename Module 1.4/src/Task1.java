...
public class Task1 {
    public static void main(String[] args) {
        ...
        String[] lastNames = {"Korhonen", "Virtanen", "Mäkinen", "Mäkelä", "Laine", "Heikkinen", "James", "Järvinen", "Salonen", "Turunen", "Lehtonen", "Ojala"};
        int i;
        System.out.println("Count of random names to be generated: ");
        int nameCount = Integer.parseInt(scanner.nextLine());
        for (i = 1; i <= nameCount; i++) {

            System.out.print(firstNames[(int) (Math.random() * 13 )] + " " + lastNames[(int) (Math.random() * 12 )] + "\n");
        }
    }
}
